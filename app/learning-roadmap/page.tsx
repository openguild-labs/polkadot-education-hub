...
const courseData = [
  // Beginner courses
  {
    ...
    description: "Learn the fundamentals of Rust programming language, the foundation of Polkadot development.",
    level: "beginner",
    category: "Rust",
    duration: "10 hours",
    prerequisites: [],
  ...
  // Intermediate courses
  {
    ...
    description: "Master advanced Rust concepts including ownership, traits, and async programming.",
    level: "intermediate",
    category: "Rust",
    duration: "15 hours",
  ...
  },
  {
    ...
    description: "Develop smart contracts using ink!, Substrate's Rust-based smart contract language.",
    level: "intermediate",
  ...
  },
  {
    ...
    description: "Build custom runtime modules using FRAME, Substrate's runtime development framework.",
    level: "intermediate",
    category: "Substrate",
    duration: "16 hours",
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
          ...
          <div className="mx-auto max-w-3xl text-center">
            ...
            <AnimateInView animation="slideUp" delay={0.1}>
              <p className="mt-4 text-lg text-gray-600 dark:text-gray-300">
                Visualize your learning journey with our interactive roadmap showing course prerequisites and
                relationships
              </p>
            </AnimateInView>
          </div>
        ...
        <div className="mb-8 rounded-xl bg-white p-6 shadow-md dark:bg-gray-800">
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <div className="rounded-lg border border-gray-200 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-900">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-300">
                Follow the connecting lines to see the recommended learning path from beginner to advanced.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="grid gap-8 md:grid-cols-2">
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-800 dark:bg-gray-800">
            ...
            <p className="mb-4 text-gray-600 dark:text-gray-300">
              Our recommended learning paths are designed to guide you through the Polkadot ecosystem in a structured
              way. Start with the fundamentals and progress to advanced topics as you build your skills.
            </p>
            <div className="space-y-4">
              ...
              <div>
                <h3 className="mb-1 font-bold text-blue-600 dark:text-blue-400">Intermediate Path</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
                  Continue with Advanced Rust → Substrate Introduction → FRAME Pallets or ink! Smart Contracts
                </p>
              </div>
              <div>
                <h3 className="mb-1 font-bold text-purple-600 dark:text-purple-400">Advanced Path</h3>
                <p className="text-sm text-gray-600 dark:text-gray-300">
          ...
          <div className="rounded-xl border border-gray-200 bg-white p-6 shadow-md dark:border-gray-800 dark:bg-gray-800">
            ...
            <p className="mb-6 text-gray-600 dark:text-gray-300">
              Not sure where to start? Take our skills assessment to get a personalized learning path based on your
              current knowledge and goals.
            </p>
            <div className="flex flex-col gap-4 sm:flex-row">
              <Button className="rounded-full bg-pink-600 hover:bg-pink-500">Take Skills Assessment</Button>
      ...
      <section className="bg-gradient-to-r from-pink-600 to-purple-600 py-16 text-white">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="font-heading text-3xl font-bold sm:text-4xl">Ready to Start Your Learning Journey?</h2>
