    ...
    >
      ...
      <div className="rounded-lg bg-gray-100 p-4 dark:bg-gray-800">
        ...
        <p className="text-sm text-gray-600 dark:text-gray-300">
          This preview showcases the teaching style and content quality of the course. In this
          lesson, you'll get an introduction to the Polkadot ecosystem and learn about the core
          concepts that will be covered throughout the course.
        </p>
      </div>
    </motion.div>
  );
