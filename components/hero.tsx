  ...
  return (
    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 sm:py-24 lg:px-8 lg:py-24">
        <div className="mx-auto max-w-4xl shadow-lg bg-white px-10 py-14 rounded-3xl flex items-center justify-center flex-col text-center">
          ...
          <AnimateInView animation="slideUp" delay={0.2} duration={0.8}>
            <p className="mt-6 text-lg leading-8 text-gray-600 dark:text-gray-300 font-unbounded">
              {subtitle}
            </p>
          </AnimateInView>
              ...
              <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
                ...
                {secondaryButton && (
                  <Button
                    variant="outline"
                    size="lg"
                    className="rounded-md font-unbounded px-6 py-3 text-lg font-semibold transition-all duration-300 hover:bg-gray-100/50 dark:hover:bg-gray-800/50"
                  >
