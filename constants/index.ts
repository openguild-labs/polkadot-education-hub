...
export const workshops = [
  ...
  },
  {
    ...
    description: "A deep dive into Dedot, exploring the workflow of building decentralized applications on Polkadot.",
  ...
  },
  {
    ...
    description: "An analysis of Polkadot SDK source code, providing insights into its architecture and functionality.",
  ...
  },
  {
    ...
    description: "An exploration of how Polkadot facilitates decentralized finance across multiple blockchains.",
  ...
  },
  {
    ...
    description: "A comprehensive guide to Web 3.0 and its potential to revolutionize the internet.",
  ...
  },
  {
    ...
    description: "A step-by-step guide on building decentralized applications (dApps) using Polkadot.",
  ...
  },
  {
    ...
    description: "Learn about techniques for creating and managing upgradeable smart contracts on Polkadot.",
  ...
  },
  {
    ...
    description: "An overview of Vara Network, designed to support secure and efficient smart contract development.",
...
export const bootcampPolkadotSdkVideos = [
  ...
  {
    title: "Open Polkadot Bootcamp 2025 - Substrate Storage Abstractions & Common Storage [Section 4 | Part 3]",
    description:
  ...
  {
    title: "Open Polkadot Bootcamp - Interact with Substrate node on PolkadotJS Apps [Section 5 | Part 1]",
    description:
  ...
  {
    title: "Open Polkadot Bootcamp - Introduction to XCM, Transport Protocols & XCVM [Section 10 | Part 1]",
    description:
  ...
  {
    title: "Open Polkadot Bootcamp - XCM Fundamentals with Locations & Assets [Section 10 | Part 2]",
    description:
...
export const bootcampSolidityOnPolkaVmVideos = [
  ...
  {
    title: "Open Polkadot Bootcamp 2025 - PolkaVM - Structure of a Solidity file - [Section 1 | Part 2]",
    description:
  ...
  {
    title: "Open Polkadot Bootcamp 2025 - PolkaVM - Expression and Control Structures - [Section 3 | Part 4]",
...
export const rustTutorials = [
  {
    ...
    description: "Introduce Rust programming language and help the participants to get familiar with the language.",
...
export const technicalActivityProjects = [...substrateTutorials, ...rustTutorials, ...inkTutorials].sort(
...
export const learningResources = [
  ...
  {
    "Course Name": "Polkadot Study - How to implement decentralized exchange in ink! smart contract language",
    Status: "Done",
    "Third-party source": "Yes",
